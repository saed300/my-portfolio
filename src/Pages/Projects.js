      ...
      <div className='section-projects-background'>
        ...
        <div className='section-projects-content'>
          <div className='parent-text-and-image'>
            <a href='https://github.com/saed300/React-Movie-Search-API'><img src={movie} alt='movie-website' className='images image1' /></a>
            <h5 style={{color: '#007bff', fontWeight: 500, fontSize: '16px'}} className='project-title'>Movie API</h5>
            <p className='project-description'>Movie search API project built using react. Made be utilising the useEffect hook and use State hook to show popular movies and searchable movies.</p>
          </div>
          <div className='parent-text-and-image second-section'>
            <a href='https://github.com/saed300/React-Custom-Hook-Form-Validation-'><img src={form} alt='Form-website' className='images image2' /></a>
          ...
          <div className='parent-text-and-image second-section'>
            <a href='https://github.com/saed300/React-Router-Framer-Motion'><img src={model} alt='movie-website' className='images image3' /></a>
        ...
        <h3 className='intro-tagline github-title'>View my other Projects!<span className='finger-right-emoji github-emoji'>👉</span><a className='email-link border-bottom' href= "https://github.com/saed300"><BsGithub size={30} className='github-logo'/></a></h3>
        <div className='footer-section'>
          <div className='footernav'>
            <h2 className='footer-heading'>Developed by Saed 🤘 </h2>
            <div className='span-arrangment'>
              <span className='footer-span'><a href = "mailto: saliviole@gmail.com" className='bof bofA'>Email</a></span>
              <span className='footer-span'><a href='https://www.linkedin.com/in/saed-saleiman-ali-665b8b177/' className='bof'>LinkedIn</a></span>
              <span className='footer-span'><a href='https://github.com/saed300' className='bof'>Github</a></span>
